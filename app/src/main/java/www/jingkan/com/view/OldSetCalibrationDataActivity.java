...
import www.jingkan.com.databinding.ActivityOldSetCalibrationDataBinding;
 ...
 * LastCPT 2
 */
public class OldSetCalibrationDataActivity extends BaseMVVMDaggerActivity<OldSetCalibrationDataVM, ActivityOldSetCalibrationDataBinding> {
    @Inject
    ...
    private void showSetDialog() {
        Dialog alertDialog = new AlertDialog.Builder(OldSetCalibrationDataActivity.this)
                .setTitle("设置探头内存数据")
    ...
    private void showSwitchDialog(int which) {
        switch (which) {
            case 0://侧壁通道
                ...
                break;
            case 1://测斜通道
                alertDialog = new AlertDialog.Builder(OldSetCalibrationDataActivity.this)
                        .setTitle("变换采集通道")
    ...
    @Override
    public int initView() {
        return R.layout.activity_old_set_calibration_data;
    }

    @Override
    public OldSetCalibrationDataVM createdViewModel() {
