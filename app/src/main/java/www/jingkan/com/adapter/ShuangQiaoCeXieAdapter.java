...
public class ShuangQiaoCeXieAdapter extends ArrayAdapter<String[]> {

	private Context context;
	private int resource;
	private List<String[]> objects;
	public ShuangQiaoCeXieAdapter(Context context, int resource, List<String[]> objects) {
